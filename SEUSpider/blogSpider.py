...
Cookie = "_T_WM=18356228864; WEIBOCN_FROM=1110006030; XSRF-TOKEN=3d6bd2; SUB=_2A25ygWHPDeRhGeNO7lET8y7OyTqIHXVRig-HrDV6PUJbktANLXKskW1NTvorNll358Nr1-efj5zLxux9cdORdOc1; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFa5-A4EOcMk4xvp.aQFWpY5NHD95Qfeh-0eoe7eozcWs4DqcjHi--RiKy2iK.Ei--fi-zEiKLFdsLV; SUHB=0pHxZ1sjIe33Aa; SSOLoginState=1602556319; MLOGIN=1; M_WEIBOCN_PARAMS=lfid%3D102803%26luicode%3D20000174%26uicode%3D20000174"
class Weibo(object):
...
def main():
    try:
        ...
        user_id = 1703010470  # 可以改成任意合法的用户id（爬虫的微博id除外）
