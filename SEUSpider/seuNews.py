...
#所有新闻板块的zoneId
zoneIDList = ["5485",          "5513", "5528", "5527", "hzjl",
			  "5496", "5530", "5526", "5495", "5529", "5525"    ]
zoneIDListTest = ["5487", "5486", ]
#"5537" 视频
sleepTime = 0
class News:
...
def putIntoMogo(InfoList):
    ...
    db= client.seuNews
    # 建表
    wx_message_sheet = db.seu_news_message
...
if __name__ == '__main__':
	for id in zoneIDList:
		...
		print(allSourceUrl)
		print("获取所有新闻中：...")
		for index in range(370, len(allSourceUrl)):
			...
			for url in getfromSourceUrl:
				...
				title, newsTime, viewCount, article = news.getNewsDetail(url)
				print(title, newsTime, viewCount, article)
